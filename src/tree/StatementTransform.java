...
public interface  StatementTransform<ResultType> {
    ...
    ResultType visitRepeatNode( StatementNode.RepeatUntilNode node );
    ResultType visitDoWhileNode( StatementNode.DoWhileNode node );
    
    ResultType visitBreakNode( StatementNode.BreakNode node );
    ResultType visitContinueNode( StatementNode.ContinueNode node );
    
    ResultType visitReturnNode( StatementNode.ReturnNode node ); 
    
    ResultType visitCasNode( StatementNode.CasNode node );
    
    ResultType visitLockNode( StatementNode.LockNode node );
    ResultType visitUnlockNode( StatementNode.UnlockNode node );
}
