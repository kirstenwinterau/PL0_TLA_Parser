...
public interface StatementVisitor {
    ...
    void visitRepeatNode( StatementNode.RepeatUntilNode node);
    void visitDoWhileNode( StatementNode.DoWhileNode node);
    
    void visitBreakNode( StatementNode.BreakNode node );
    void visitContinueNode( StatementNode.ContinueNode node );
    
    void visitReturnNode( StatementNode.ReturnNode node );
    
    void visitCasNode( StatementNode.CasNode node );
    
    void visitLockNode( StatementNode.LockNode node );
    void visitUnlockNode( StatementNode.UnlockNode node );
}
