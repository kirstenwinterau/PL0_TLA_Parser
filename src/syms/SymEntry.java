...
public abstract class SymEntry {
    ...
    public static class VarEntry extends SymEntry {
        ...
        public VarEntry(String id, Position p, Scope s, ReferenceType t, boolean isGlobal, boolean isAbstract ) {
            super( id, p, s, t, false );
    ...
    public static class ProcedureEntry extends SymEntry {
        ...
        private ExpNode args;
        
        public ProcedureEntry( String id, Position p, Scope s, 
                                  Type.ProcedureType type, List<Type> returnTypes, ExpNode args ) {
            super( id, p, s, type, false );
            this.returnTypes = returnTypes;
            this.args = args;
        } 
        public ProcedureEntry( String id, Position p, Scope s, List<Type> returnTypes, ExpNode args ) {
            this( id, p, s, new Type.ProcedureType(), returnTypes, args);
        }
        @Override
