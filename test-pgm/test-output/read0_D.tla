...
Init == /\ x1 \in X /\ x2 \in X /\ c \in C /\ xa1 \in X /\ xa2 \in X /\ lock \in {TRUE, FALSE} /\ ABS /\ pc = 0 /\ c0 = 0 /\ d1 = 0 /\ d2 = 0 /\ INV /\ out \in X \X X /\ out[1] = 0 /\ out[2] = 0 /\ in = 0  /\ STATUS
...
read0 ==  pc = 0 /\ pc' = 21 /\ UNCHANGED<<d2q,c,in,c0q,d1q,xa2,xa1,c0,d1,inq,d2,out,outq,x1,lock,x2,pcq>> 

Spec ==  Init /\ [][read0]_<<d2q, c, in, c0q, d1q, xa2, xa1, c0, d1, inq, d2, out, pc, outq, x1, lock, x2, pcq>> 
