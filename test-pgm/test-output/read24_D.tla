...
Init == /\ x1 \in X /\ x2 \in X /\ c \in C /\ xa1 \in X /\ xa2 \in X /\ lock \in {TRUE, FALSE} /\ ABS /\ pc = 24 /\ c0 \in C /\ d1 \in X /\ d2 \in X /\ INV /\ out \in X \X X /\ out[1] = 0 /\ out[2] = 0 /\ in = 0  /\ STATUS
...
read24 ==  pc = 24 /\ pc' = 25 /\ d2' = x2 /\ UNCHANGED<<d2q,c,in,c0q,d1q,xa2,xa1,c0,d1,inq,out,outq,x1,lock,x2,pcq>> 

Spec ==  Init /\ [][read24]_<<d2q, c, in, c0q, d1q, xa2, xa1, c0, d1, inq, d2, out, pc, outq, x1, lock, x2, pcq>> 
