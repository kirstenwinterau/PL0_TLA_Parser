...
Init == /\ stack \in FiniteSeq(T, N) /\ head \in Ref \union {null} /\ mem \in [Ref ->(T \X (Ref \union {null})) \union {undef}] /\ ABS /\ ss = null /\ pc = 0 /\ v = 0 /\ n = null /\ INV /\ in = 0 /\ lv = 0  /\ out = 0  /\ ssn = 0  /\ STATUS
...
push0 ==  pc = 0 /\ pc' = 15 /\ v' \in T /\ in' = v' /\ UNCHANGED<<ss,stack,nq,lvq,lv,inq,n,out,ssn,head,ssq,mem,ssnq,outq,vq,pcq>> 

Spec ==  Init /\ [][push0]_<<ss, stack, nq, in, lvq, lv, inq, n, out, ssn, head, ssq, pc, mem, ssnq, v, outq, vq, pcq>> 
