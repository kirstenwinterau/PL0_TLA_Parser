...
Init == /\ stack \in FiniteSeq(T, N) /\ head \in Ref \union {null} /\ mem \in [Ref ->(T \X (Ref \union {null})) \union {undef}] /\ ABS /\ ss = null /\ pc = 16 /\ v \in T /\ n \in Ref /\ INV /\ in \in T /\ lv = 0  /\ out = 0  /\ ssn = 0  /\ STATUS
...
push16 ==  pc = 16 /\ pc' = 19 /\ mem' = [mem EXCEPT ![n] = <<v,@[2]>>] /\ UNCHANGED<<ss,stack,nq,in,lvq,lv,inq,n,out,ssn,head,ssq,ssnq,v,outq,vq,pcq>> 

Spec ==  Init /\ [][push16]_<<ss, stack, nq, in, lvq, lv, inq, n, out, ssn, head, ssq, pc, mem, ssnq, v, outq, vq, pcq>> 
