...
read22F ==  pc = 22 /\ pc' = 23 /\ c % 2 = 0 /\ UNCHANGED<<d2q,c,in,c0q,d1q,xa2,xa1,c0,d1,inq,d2,out,outq,x1,lock,x2,pcq>> 

Spec ==  Init /\ [][read22F]_<<d2q, c, in, c0q, d1q, xa2, xa1, c0, d1, inq, d2, out, pc, outq, x1, lock, x2, pcq>> 
