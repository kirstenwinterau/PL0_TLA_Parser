...
Init == /\ stack \in FiniteSeq(T, N) /\ head \in Ref \union {null} /\ mem \in [Ref ->(T \X (Ref \union {null})) \union {undef}] /\ ABS /\ ss \in Ref \union {null} /\ pc = 33 /\ lv \in T /\ ssn \in Ref \union {null} /\ INV /\ out = 0 /\ in = 0  /\ v = 0  /\ n = 0  /\ STATUS
...
pop33 ==  pc = 33 /\ pc' = 0 /\ UNCHANGED<<ss,stack,nq,in,lvq,lv,inq,n,out,ssn,head,ssq,mem,ssnq,v,outq,vq,pcq>> 

Spec ==  Init /\ [][pop33]_<<ss, stack, nq, in, lvq, lv, inq, n, out, ssn, head, ssq, pc, mem, ssnq, v, outq, vq, pcq>> 
