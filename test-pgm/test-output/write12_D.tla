...
Init == /\ x1 \in X /\ x2 \in X /\ c \in C /\ xa1 \in X /\ xa2 \in X /\ lock \in {TRUE, FALSE} /\ ABS /\ pc = 12 /\ d1 \in X /\ d2 \in X /\ INV /\ in \in X \X X /\ c0 = 0  /\ out = 0  /\ STATUS
...
write12 ==  pc = 12 /\ pc' = 13 /\ x1' = d1 /\ UNCHANGED<<d2q,c,in,c0q,d1q,xa2,xa1,d1,inq,c0,d2,out,outq,lock,x2,pcq>> 

Spec ==  Init /\ [][write12]_<<d2q, c, in, c0q, d1q, xa2, xa1, d1, inq, c0, d2, out, pc, outq, x1, lock, x2, pcq>> 
