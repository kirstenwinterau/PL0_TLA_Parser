...
Init == /\ stack \in FiniteSeq(T, N) /\ head \in Ref \union {null} /\ mem \in [Ref ->(T \X (Ref \union {null})) \union {undef}] /\ ABS /\ ss = null /\ pc = 0 /\ lv = 0 /\ ssn = null /\ INV /\ out = 0 /\ in = 0  /\ v = 0  /\ n = 0  /\ STATUS
...
pop0 ==  pc = 0 /\ pc' = 31 /\ UNCHANGED<<ss,stack,nq,in,lvq,lv,inq,n,out,ssn,head,ssq,mem,ssnq,v,outq,vq,pcq>> 

Spec ==  Init /\ [][pop0]_<<ss, stack, nq, in, lvq, lv, inq, n, out, ssn, head, ssq, pc, mem, ssnq, v, outq, vq, pcq>> 
