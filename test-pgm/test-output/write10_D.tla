...
Init == /\ x1 \in X /\ x2 \in X /\ c \in C /\ xa1 \in X /\ xa2 \in X /\ lock \in {TRUE, FALSE} /\ ABS /\ pc = 10 /\ d1 \in X /\ d2 \in X /\ INV /\ in \in X \X X /\ c0 = 0  /\ out = 0  /\ STATUS
...
write10 ==  pc = 10 /\ pc' = 11 /\ lock = FALSE /\ lock' = TRUE /\ UNCHANGED<<d2q,c,in,c0q,d1q,xa2,xa1,d1,inq,c0,d2,out,outq,x1,x2,pcq>> 

Spec ==  Init /\ [][write10]_<<d2q, c, in, c0q, d1q, xa2, xa1, d1, inq, c0, d2, out, pc, outq, x1, lock, x2, pcq>> 
