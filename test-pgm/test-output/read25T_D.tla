...
read25T ==  pc = 25 /\ pc' = 21 /\ c /= c0 /\ UNCHANGED<<d2q,c,in,c0q,d1q,xa2,xa1,c0,d1,inq,d2,out,outq,x1,lock,x2,pcq>> 

Spec ==  Init /\ [][read25T]_<<d2q, c, in, c0q, d1q, xa2, xa1, c0, d1, inq, d2, out, pc, outq, x1, lock, x2, pcq>> 
