...
Init == /\ stack \in FiniteSeq(T, N) /\ head \in Ref \union {null} /\ mem \in [Ref ->(T \X (Ref \union {null})) \union {undef}] /\ ABS /\ ss \in Ref \union {null} /\ pc = 37 /\ lv \in T /\ ssn \in Ref \union {null} /\ INV /\ out = 0 /\ in = 0  /\ v = 0  /\ n = 0  /\ STATUS
...
pop37T ==  pc = 37 /\ pc' = 38 /\ head = ss /\ head' = ssn /\ UNCHANGED<<ss,stack,nq,in,lvq,lv,inq,n,out,ssn,ssq,mem,ssnq,v,outq,vq,pcq>> 

Spec ==  Init /\ [][pop37T]_<<ss, stack, nq, in, lvq, lv, inq, n, out, ssn, head, ssq, pc, mem, ssnq, v, outq, vq, pcq>> 
