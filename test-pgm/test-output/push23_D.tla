...
Init == /\ stack \in FiniteSeq(T, N) /\ head \in Ref \union {null} /\ mem \in [Ref ->(T \X (Ref \union {null})) \union {undef}] /\ ABS /\ ss \in Ref \union {null} /\ pc = 23 /\ v \in T /\ n \in Ref /\ INV /\ in \in T /\ lv = 0  /\ out = 0  /\ ssn = 0  /\ STATUS
...
push23 ==  pc = 23 /\ pc' = 0 /\ UNCHANGED<<ss,stack,nq,in,lvq,lv,inq,n,out,ssn,head,ssq,mem,ssnq,v,outq,vq,pcq>> 

Spec ==  Init /\ [][push23]_<<ss, stack, nq, in, lvq, lv, inq, n, out, ssn, head, ssq, pc, mem, ssnq, v, outq, vq, pcq>> 
