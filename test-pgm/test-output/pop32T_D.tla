...
Init == /\ stack \in FiniteSeq(T, N) /\ head \in Ref \union {null} /\ mem \in [Ref ->(T \X (Ref \union {null})) \union {undef}] /\ ABS /\ ss \in Ref \union {null} /\ pc = 32 /\ lv \in T /\ ssn \in Ref \union {null} /\ INV /\ out = 0 /\ in = 0  /\ v = 0  /\ n = 0  /\ STATUS
...
pop32T ==  pc = 32 /\ pc' = 33 /\ ss = null /\ UNCHANGED<<ss,stack,nq,in,lvq,lv,inq,n,out,ssn,head,ssq,mem,ssnq,v,outq,vq,pcq>> 

Spec ==  Init /\ [][pop32T]_<<ss, stack, nq, in, lvq, lv, inq, n, out, ssn, head, ssq, pc, mem, ssnq, v, outq, vq, pcq>> 
